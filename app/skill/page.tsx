...
const skillsData: SkillData[] = [
  ...
  { src: "/aws2.png", alt: "AWS", description: "EC2를 활용하여 프로젝트를 호스팅 한 경험이 있으며 도메인을 통한 배포 과정도 진행한 적이 있습니다." },
  ...
  { src: "/tailwind.png", alt: "Tailwind", description: "ERP 프로젝트를 진행하면서 클래스 기반의 스타일링을 통해 웹 디자인을 쉽게 구현할 수 있습니다." },
  { src: "/nextjs.svg", alt: "Next.js", description: "서버 사이드 렌더링" },
  { src: "/python.png", alt: "Python", description: "Python 대한 설명" },
  { src: "/notion.svg", alt: "Notion", description: "Notion 대한 설명" },
  { src: "/slack2.png", alt: "Slack", description: "팀 간의 실시간 커뮤니케이션을 강화하고 협업을 위해 사용했습니다." },
